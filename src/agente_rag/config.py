...
class Settings:
    ...
    # Variables de PoliGPT requeridas para la Banda 7
    ...
    def from_env(cls) -> Settings:
        ...
        return cls(
            ...
            collection_name=os.getenv("COLLECTION_NAME", "dni_v2"), 
            api_host=os.getenv("API_HOST", "127.0.0.1"),
            api_port=int(os.getenv("API_PORT", "8000")),
            corpus_dir=Path(os.getenv("CORPUS_DIR", str(ruta_corpus))), 
            
            # Credenciales de PoliGPT
